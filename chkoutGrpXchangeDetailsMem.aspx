<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="chkoutGrpXchangeDetailsMem.aspx.cs" Inherits="FPSMarketPlace.chkoutGrpXchangeDetailsMem" %>
 ...
 <!--End of Right content-->
  ...
  <div class="right_Xchange">
	...
	<table width="98%" align="center"  bordercolor="#8F8F91" style="border-style:dashed; border-width:thin; padding: 3">
		<tr>
          <td width="25%" height="29" >Price Per <asp:Label ID="lblTypeUnits" runat="server"></asp:Label></td>
	...
	<td>
	  <table bgcolor="#CACACA" width="98%" height="12" align="center" bordercolor="#8F8F91" style="border-style:dashed; border-width:thin; padding: 3">
		...
		<tr>
          ...
          <td width="75%"><div align="left"><span class="style6">Total Charges (Including</span><span class="style13"> Domestic</span><span class="style6"> Shipping)</span></div></td>
        </tr>
          ...
          <tr>
              <td style="height: 263px">
                  <table width="98%" align="center"  bordercolor="#8F8F91" style="border-style:dashed; border-width:thin; padding: 3">
                      <tr>
                          <td height="29" style="width: 214px" colspan="2" >
                              Partial Payment Paid</td>
                          <td style="width: 31%">
                          <asp:TextBox ID="txtAmtPaid" runat="server" Width="71px" ReadOnly="True" >0</asp:TextBox></td>
                      </tr>
                      <tr>
                          <td colspan="2" height="29" style="width: 214px">
                              Remaining Charges</td>
                          <td style="width: 31%">
                          <asp:TextBox ID="txtRemainingCharges" runat="server" Height="22px" Width="71px" ReadOnly="True" ></asp:TextBox></td>
                      </tr>
                      <tr>
                          <td colspan="2" height="29" style="width: 214px">
                              Add your partial payment equal or less than total remaining charges</td>
                          <td style="width: 31%">
                          <asp:TextBox ID="txtAmountPaying" runat="server" Height="22px" Width="71px"></asp:TextBox>
        <span class="style2" style="color: #cc0000">* </span>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtAmountPaying"
            ErrorMessage="Enter City" ValidationGroup="UploadNew">Required</asp:RequiredFieldValidator></td>
                      </tr>
                      <tr>
                          <td colspan="2" style="width: 214px; height: 30px">
                              <span style="color: #000000">Suffix:</span></td>
                          <td style="width: 31%; height: 30px">
                              <asp:DropDownList ID="drpSuffix" runat="server" Width="56px">
                      ...
                      <tr>
                          <td colspan="2" rowspan="1" style="width: 214px">
                              <span style="color: #000000">First/ Given name:</span></td>
                          <td style="width: 31%">
                      ...
                      <tr>
                          <td colspan="2" rowspan="1" style="width: 214px">
                              <span style="color: #000000">Last Name/Surname:</span></td>
                          <td style="width: 31%">
                      ...
                      <tr>
                          <td colspan="2" rowspan="1" style="width: 214px; height: 43px">
                              <span style="color: #000000">E-mail :&nbsp;</span></td>
                          <td style="width: 31%; height: 43px">
                      ...
                      <tr>
                          <td colspan="2" style="width: 214px" rowspan="2">
    ...
    <table width="475" align="center" bspan class="background_color" cellpadding="5" cellspacing="0" >
         <tr><td colspan="2" valign="middle" height="35px" span class="header_background_color"><div class="heading">
             Host Shipping&nbsp; information:</div></td>
      </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="322">
        <asp:Label ID="lblBuyerName" runat="server" Width="290px"></asp:Label></td>
  ...
  <tr>
    ...
    <td>
       <span class="style1">
           <asp:Label ID="lblBuyerZipCode" runat="server" Width="290px" ForeColor="Black"></asp:Label></span></td>
    
  </tr>
  <tr>
    <td style="width: 179px"><span class="style1">Buyer Email ID:</span></td>
    <td> 
        <asp:Label ID="lblBuyerEmailId" runat="server" Width="290px"></asp:Label></td>
   
  </tr>
  <tr>
    <td style="width: 179px"><span class="style1">Shipping To:</span></td>
    <td>  
        <asp:Label ID="lblBuyerShippingAdd" runat="server" Height="65px" Width="290px"></asp:Label></td>
    
  </tr>
  <tr>
    <td style="width: 179px"><span class="style1">Phone:</span></td>
    <td>
        <asp:Label ID="lblBuyerPhNo" runat="server" Width="290px"></asp:Label></td>
  ...
  <tr>
    <td align="center">
        <strong><span style="font-size: 16pt; font-family: Arial">Group Buyer</span></strong>
        </td>
  </tr>
  <tr>
...
<!--Footer-->
  <div class="footer"><a href="index.aspx">Marketplace Powered by EMarketStar.com <small>(Formerly HouseDNA.com)</small></a></div>
  <!--End of Footer-->
