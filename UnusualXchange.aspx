...
<!--Header-->
 ...
 <!--Left content--> 
  ...
  <div class="right">
	...
	<tr>
		...
		<td width="20%" valign="top"><asp:LinkButton ID="LinkButton1" runat="server" ForeColor="Gray" OnClick="LinkButton1_Click">Lowest Price</asp:LinkButton></td>
		<td width="23%" valign="top"> <asp:LinkButton ID="LinkButton2" runat="server" ForeColor="Gray" OnClick="LinkButton2_Click">Location</asp:LinkButton></td>
		<td width="24%" valign="top"><asp:LinkButton ID="LinkButton3" runat="server" ForeColor="Gray" OnClick="LinkButton3_Click">Category</asp:LinkButton></td>
	</tr>
 ...
 <ItemTemplate>
	...
	<table width="100%" span class="background_color">
		<tr>
			...
			<tr>
				...
				<td width="71"  valign="top">Select&gt;&gt;</td>
			</tr>
			</table>			</td>
		</tr>
		<tr>
  ...
  <div class="footer">
    <p><a href="www.housedna.com">Powered by HouseDNA.com</a></p>
  </div>
  <!--End of Footer-->
</div>
    </form>
