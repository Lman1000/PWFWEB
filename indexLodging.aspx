<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="indexLodging.aspx.cs" Inherits="FPSMarketPlace.indexLodging" %>
...
<!-- #Include File="indexSidePanel.inc" -->
  ...
  <div class="pagecontent">
   <table width="100%" align="center" cellpadding="5" cellspacing="0">
		...
		<tr>
		  <td height="40" span class="line_background"><span class="headers_with_bg_lines">Reservations</span></td>
        </tr>
		
		<tr>
              <td><div align="justify">We provide instant infrastructure and tools that allows one to start  lodging, parking, limousine, carpool, spa, dining, ticketing, and many  more businesses that require reservation booking platform for daily and  nightly reservations. One can open a reservation business homepage  within few minutes, and paywithfriends.com provides the tools that  automatically keep track of reservations and availability, move orders,  transactions, confirmations and even refunds in ones account page.  Every member receives a unique URL (member.paywithfriends.com) that links  directly to ones reservation homepage and their business shows &amp;  description (shows that help search engines such as Google to find  vendors or service providers directly through paywithfriends.com data base).</div></td>
        </tr>
		<tr>
		...
		<tr>
		  <td valign="top"><table width="100%" border="0" cellpadding="2">
            <tr>
              <td valign="top" width="50%" rowspan="2"><div align="justify">Choose your username (business name) and password, and then confirm an  email address. There&rsquo;s an extra one time step of signing up to start  creating and receiving reservations. Once logged in. You are required  to activate your Amazon Payments account via your paywithfriends.com eXchange  account to receive payments from lodgers.</div></td>
		...
		<tr>
			<td><table width="100%" border="0" cellpadding="2">
              <tr>
                <td valign="top" rowspan="2"><div align="justify">Open your reservations homepage. All members on  marketplace get their own URL for their reservation services only (homepage), located in account page. Your unique URL business platform  homepage can be linked directly to your reservation, gallery and   Energy station businesses. You can link your homepage URL  with your social websites, internet ads (like Google, blogs, home  away), and many more places. Also one can find reservations with  Search Market Tool.</div></td>
                ...
                <td><div align="center"><a href="javascript:CaricaFoto('images/energystation_gallery_reservations_storefront_shows_images/YourBusinesPlatform_b.jpg')">Enlarge Your Site </a></div></td>
              </tr>
              <tr>
		...
		<tr>
		  <td class="page_header">Listing Daily or Nightly Reservations</td>
	    </tr>
		<tr>
		  <td background="images/dotted.gif" style="background-repeat:repeat-x"> </td>
	    </tr>
		<tr>
		  <td valign="top"><table width="100%" border="0" cellpadding="2">
            <tr>
              <td valign="top" width="50%" rowspan="2"><div align="justify">Listing reservations (items) is done in three simple steps. We  recommend that you&rsquo;ve got your photos and business description for each  service ready before jumping in.</div></td>
              <td width="50%"><div align="center"><a href="javascript:CaricaFoto('images/energystation_gallery_reservations_storefront_shows_images/eXchange-listing-Item_b.jpg')"> Enlarge Listing Reservations (Item)</a></div></td>
            </tr>
            <tr>
              <td><div align="center"><img src="images/energystation_gallery_reservations_storefront_shows_images/eXchange-listing-Item.jpg" alt="" width="150" height="150" /></div></td>
            </tr>
          </table>
	      </td>
	    </tr>
		...
		<tr>
		  <td class="page_header">Payments</td>
	    </tr>
		<tr>
		  <td background="images/dotted.gif" style="background-repeat:repeat-x"> </td>
	    </tr>
		<tr>
		  <td valign="top"><table width="100%" border="0" cellpadding="2">
            <tr>
              ...
              <td width="50%"><div align="center"><a href="javascript:CaricaFoto('images/energystation_gallery_reservations_storefront_shows_images/Checkout-Lodging_b.jpg')">Enlarge                                                                        Reservation Checkout</a></div></td>
            </tr>
            <tr>
              <td><div align="center"><img src="images/energystation_gallery_reservations_storefront_shows_images/Checkout-Lodging.jpg" alt="" width="150" height="150" /></div></td>
            </tr>
          </table>
	      </td>
	    </tr>
