<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="confirmationElFPS.aspx.cs" Inherits="FPSMarketPlace.confirmationElFPS" %>
...
<table width="520" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td style="height: 15px"><span class="style30"> Hours Request: </span></td>
  ...
  <tr>
    ...
    <td class="style31" style="height: 15px"><span class="style29"><span style="font-size: 10pt; color: blue; font-family: Arial;
            mso-fareast-font-family: 'Times New Roman'; mso-ansi-language: EN-US; mso-fareast-language: EN-US;
            mso-bidi-language: AR-SA">Charging Plug - In - Electric Car</span></span></td>
    <td style="height: 15px"><span class="style29"></span></td>
  </tr>
  <tr>
    <td style="height: 15px"><span class="style29"></span></td>
    <td style="height: 15px"><span class="style30"> <span style="font-family: Arial"><span style="font-size: 10pt">
            <span style="color: black"><span style="mso-fareast-font-family: 'Times New Roman';
                mso-ansi-language: EN-US; mso-fareast-language: EN-US; mso-bidi-language: AR-SA">
                Parking charges per hour</span>: </span></span></span></span></td>
  ...
  <tr>
    <td><span class="style29"></span></td>
    <td><span class="style30"> Total charges: </span></td>
  ...
  <tr>
    <td colspan="2"><span class="style13"> Service to </span></td>
    <td class="style31"><span class="style29"></span></td>
    <td><span class="style29"></span></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="style31"><span class="style29"> <span class="style31"><span style="font-size: 10pt; color: blue;
            font-family: Arial; mso-fareast-font-family: 'Times New Roman'; mso-ansi-language: EN-US;
            mso-fareast-language: EN-US; mso-bidi-language: AR-SA">Plug In Station</span></span></span></td>
    <td><span class="style29"></span></td>
  </tr>
  <tr>
    <td><span class="style29"></span></td>
