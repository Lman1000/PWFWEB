<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="indexShopper.aspx.cs" Inherits="FPSMarketPlace.indexShopper" %>
...
<!--end of Header-->
 ...
 <div class="left">
     ...
     <table width="100%" cellpadding="5" cellspacing="0" class="pwd_background_color">
       <tr>
         <td class="style1"><strong>Shoppers</strong></td>
       </tr>
       <tr>
	   	 <td><p><strong><a href="indexShopper.aspx" class="pwf_home_front_blue_color1">How it works</a></strong></p>
   	     <p><a href="indexShopperHtp.aspx">How to participate</a></p>
   	     <p><a href="indexShopperHtb.aspx">How to buy</a></p></td>
       </tr>
	   <tr>
	   	 <td>&nbsp;</td>
       </tr>
 ...
 <!--Right Content-->  
  ...
  <table width="100%" cellpadding="4" cellspacing="0" >
	   ...
	   <tr>
	   	 <td colspan="3"><strong>How it works:  <a href="FLVStream.aspx?vdid=2"  class="pwf_home_front_blue_color2">See video</a></strong></td>
       </tr>
	    ...
	    <tr>
	   	 <td width="33%">
             ...
             <tr>
               <td colspan="2"> <p> - Sign up fast for free and setup your Amazon Payments account to receive payments 
                 </p>
                 <p>- Post and promote any item you want to buy anywhere</p></td>
             </tr>
           </table>
         ...
         <td width="34%">
			 <table width="100%" border="0" cellspacing="0" cellpadding="2" class="pwd_background_color">
			   ...
			   <tr>
				 <td colspan="2"><p>- Make a partial payment with your Amazon account </p>
				   <p>- Email your friends to contribute to the purchase within 7 days </p>
				 </td>
			   </tr>
			 </table>
		 </td>
         <td width="33%">
			   ...
			   <tr>
				 <td colspan="2"><p>- Your friends contribute the remaining payment needed within 7 days </p>
					   <p>- Buy the item for everyone when all the money is raised</p></td>
			   </tr>
			 </table>
		 </td>
       </tr>
