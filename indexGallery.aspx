<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="indexGallery.aspx.cs" Inherits="FPSMarketPlace.indexGallery" %>
...
<!-- #Include File="indexSidePanel.inc" -->
  ...
  <div class="pagecontent">
   <table width="100%" align="center"
		...
		<tr>
		  <td height="40" span class="line_background"><span class="headers_with_bg_lines">Gallery</span></td>
        </tr>
		
		<tr>
              <td><div align="justify">
                <p>One can open an art and design gallery business within few minutes, and  paywithfriends.com platform provides the tools that automatically keep track  of goods availability, move orders, transactions, confirmations and  even refunds in ones account page. Every member receives a unique URL  (member.paywithfriends.com) that links directly to ones business homepage and  their latest shows (shows that help search engines such as Google to  find vendors directly through paywithfriends.com data base). Members&rsquo;  homepage consist of products and services that are for sale, shows, and  a search tools that only find services for the gallery owners products.</p>
		...
		<tr>
			<td><table width="100%" border="0" cellpadding="2">
              <tr>
                <td valign="top" rowspan="2"><div align="justify">Open your gallery homepage. All members on  marketplace get their own URL for their gallery (homepage), located in account page. Your unique URL business platform  homepage can be linked directly to your reservation, gallery and   Energy station businesses. You can link your homepage URL  with your social websites, internet ads (like Google, blogs, home  away), and many more places. Also one can find gallery with  Search Market Tool.</div></td>
                ...
                <td><div align="center"><a href="javascript:CaricaFoto('images/energystation_gallery_reservations_storefront_shows_images/YourBusinesPlatform_b.jpg')">Enlarge Your Gallery </a></div></td>
              </tr>
              <tr>
		...
		<tr>
		  <td valign="top"><table width="100%" border="0" cellpadding="2">
            <tr>
              <td valign="top" width="50%" rowspan="2"><div align="justify">Listing a gallery item is done in three simple steps. We recommend  that you&rsquo;ve got your photos and description ready before jumping in.</div></td>
