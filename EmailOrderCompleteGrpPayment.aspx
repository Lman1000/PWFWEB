<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmailOrderCompleteGrpPayment.aspx.cs" Inherits="FPSMarketPlace.EmailOrderCompleteGrpPayment" %>
                        ...
                        <td>
                                ...
                                <tr style="font-size: 9pt; font-family: Arial">
                                    ...
                                    <td style="width: 389px">
                                        <span class="style44">Order Number:</span></td>
                                    <td colspan="2">
                                        <span class="style44">
                                            <asp:Label ID="ORDER_NUMBER" runat="server"></asp:Label></span></td>
                                </tr>
                                <tr style="font-size: 9pt; font-family: Arial">
                                    <td style="width: 204px">
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="2">
                                        <strong class="style44"><span style="font-size: 9pt; font-family: Arial">Item Detail:</span></strong></td>
                                    <td style="font-size: 9pt; font-family: Arial; width: 402px;">
                                        <span class="style45"></span>
                                    </td>
                                    <td style="font-size: 9pt; font-family: Arial; width: 638px;">
                                ...
                                <tr>
                                    ...
                                    <td colspan="4">
                                        <span class="style44" style="font-size: 9pt; font-family: Arial"><strong>Paid:</strong></span></td>
                                </tr>
                                                          <tr>
                                                              <td style="width: 204px">
                                                              </td>
                                                              ...
                                                              <td colspan="2">
                                                                  <span style="font-size: 9pt; font-family: Arial">
                                                                      <asp:Label ID="PAYMENT_DETAILS" runat="server"></asp:Label></span></td>
                                                              <td style="width: 638px">
                                                              </td>
                                                          </tr>
                                <tr>
